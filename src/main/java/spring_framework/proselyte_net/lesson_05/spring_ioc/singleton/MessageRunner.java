package spring_framework.proselyte_net.lesson_05.spring_ioc.singleton;
...
public class MessageRunner {
    public static void main(String[] args) {
        ApplicationContext context =
                new ClassPathXmlApplicationContext("SpringFramework/proselyte_net/Lesson_05/silgleton/message-bean.xml");
